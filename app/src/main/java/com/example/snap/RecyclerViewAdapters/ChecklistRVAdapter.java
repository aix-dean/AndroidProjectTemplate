...
public class ChecklistRVAdapter extends RecyclerView.Adapter<ChecklistRVAdapter.CheckListViewHolder> {
    ...
    public ChecklistRVAdapter(ArrayList<ChecklistQuestionModel> questionModels) {
    ...
    public CheckListViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
            View layout = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_health_checklist_2,parent,false);
    ...
    public void onBindViewHolder(@NonNull CheckListViewHolder holder, int position) {
        if(position ==0 && questionModels.size() == 1){
            holder.yesCb.setVisibility(View.GONE);
            holder.noCb.setVisibility(View.GONE);
    ...
    class CheckListViewHolder extends RecyclerView.ViewHolder{
        ...
        public CheckListViewHolder(@NonNull View itemView) {
            ...
            questionDescTV = itemView.findViewById(R.id.questionDescTV);
